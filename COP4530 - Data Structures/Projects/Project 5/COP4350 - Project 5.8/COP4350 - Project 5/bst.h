...
BinarySearchTree<T>::BinarySearchTree(const BinarySearchTree& originalTree) {
   ...
   //// If there is an existing tree, delete that tree
...
Node * &copyTreeRoot) {
   ...
   // Copy node, children, and parent
   else {
      copyTreeRoot = new Node;
      copyTreeRoot->data = originalTreeRoot->data;
      insert(originalTreeRoot->data);
   ...
   //   copyTreeRoot = new Node;
   //   copyTreeRoot->data = originalTreeRoot->data;
   //   copyTreeRoot = originalTreeRoot;
   //      //copyTreeRoot->left = originalTreeRoot->left;
   //      //copyTreeRoot->right = originalTreeRoot->right;
   //      //copyTreeRoot->parent = originalTreeRoot->parent;

   //   //// find the parent of the item
   //   //Node * parentLocation = NULL;
   //   //searchParent(originalTreeRoot->data, originalTreeRoot, parentLocation);
   //   //copyTreeRoot->parent = parentLocation;
