...
//template <class T>
//int BinarySearchTree<T>::getHeightHelper(Node * subtreeRoot) {
//   if (subtreeRoot == NULL) {
//      return -1;
//   }
//
//   //getHeightHelper(subtreeRoot->left);
//   //getHeightHelper(subtreeRoot->right);
//
...
----------------------------------------------------------------*/
template <class T>
void BinarySearchTree<T>::copyBinarySearchTree(Node * original, 
   Node * &copy) {
