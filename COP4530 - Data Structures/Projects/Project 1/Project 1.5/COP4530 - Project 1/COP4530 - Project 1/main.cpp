...
int main()
{
   ...
   MagicSquare &magicSquare(magicSquareDefault);
   &magicSquare.rotate();
   cout << "Is no work?\n";
   cout << &magicSquare;
   system("pause");
   MagicSquare magicSquare2(magicSquare);
   magicSquare2.rotate();
   cout << "is it working now?\n";
   cout << magicSquare2;
   system("pause");

   MagicSquare &magicSquare3(magicSquare2.rotate());
   cout << "is it working again?\n";
   cout << magicSquare3;
   system("pause");

   MagicSquare magicSquare4(magicSquare3);
   cout << magicSquare4.rotate();
